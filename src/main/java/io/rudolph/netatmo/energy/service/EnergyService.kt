package io.rudolph.netatmo.energy.service
...
interface EnergyService {
    ...
    fun getHomeData(
            ...
            @Query("gateway_types") gatewayTypes: MutableList<GatewayType>? = null
    ): Call<HomesData>
